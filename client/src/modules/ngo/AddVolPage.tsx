...
const AddVolPage: React.FC = () => {
  ...
  return (
    <section id="add_vol" className='mx-auto max-w-screen-xl p-4 md:px-6 xl:px-10 relative'>
      ...
      <div className=" flex flex-col-reverse md:grid grid-cols-5 grid-rows-5 gap-4 lg:gap-16 mt-4 md:mt-6 p-4">
          ...
          <form onSubmit={handleSubmit} method='post' className='space-y-6'>
            ...
            <div className='flex items-center gap-4'>
              ...
              <div className="w-1/2 flex gap-2">
                <TextField size={'small'} placeholder='Add new zone' />
                <Button size={'icon'} variant={'dark'} ><IconSelector.all.add /></Button>
              </div>
            </div>
        ...
        <div className='col-start-4 col-span-2 row-span-5 space-y-4'>
          <form className='flex flex-col items-center space-y-4'>
            <div className='font-bold bg-green-500 w-full px-2 py-2 rounded-md text-white text-center text-lg'>
            ...
            <div className='w-36 h-36 mb-4 relative'>
              ...
              <div className='rounded-full overflow-hidden flex items-center justify-center ring-1'>
                <img src={Img.profile_dummy} alt="photo" className='object-cover ' />
              </div>
            </div>

            <div className='text-xs text-gray-700'>
              <div>Volunteer Profile Photo</div>
              <TextField type='file' />
            </div>
          ...
          <form className='space-y-4'>
            ...
            <div className='flex gap-4 text-center'>
              <div className="w-1/2 rounded-lg border-2 border-dashed border-violet-700 p-10">Front</div>
              <div className="w-1/2 rounded-lg border-2 border-dashed border-violet-700 p-10">Back</div>
            </div>
            <div>
              <div className='text-xs text-gray-700'>
                Aadhar Front Photo
